                              ...
                              <div className="tab-content">
                                <div className="tab-pane active show" id="tab-1">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-4 text-center order-1 order-lg-2">
                                      <Image width={268} height={261} src="/img/specials-1.jpg" alt="especial" className="img-fluid"/>
                                    </div>
                                  </div>
                                </div>
                                <div className="tab-pane" id="tab-2">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-4 text-center order-1 order-lg-2">
                                      <Image width={268} height={261} src="/img/specials-2.jpg" alt="especial" className="img-fluid"/>
                                    </div>
                                  </div>
                                </div>
                                <div className="tab-pane" id="tab-3">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-4 text-center order-1 order-lg-2">
                                      <Image width={268} height={261} src="/img/specials-3.jpg" alt="especial" className="img-fluid"/>
                                    </div>
                                  </div>
                                </div>
                                <div className="tab-pane" id="tab-4">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-4 text-center order-1 order-lg-2">
                                      <Image width={268} height={261} src="/img/specials-4.jpg" alt="especial" className="img-fluid"/>
                                    </div>
                                  </div>
                                </div>
                                <div className="tab-pane" id="tab-5">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-4 text-center order-1 order-lg-2">
                                      <Image width={268} height={261} src="/img/specials-5.jpg" alt="especial" className="img-fluid"/>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="swiper-wrapper">
                                ...
                                <div className="swiper-slide">
                                  <div className="row event-item">
                                    ...
                                    <Image width={546} height={364} src="/img/event-birthday.jpg" className="img-fluid" alt="events"/>
                                    </div>
                                ...
                                <div className="swiper-slide">
                                  <div className="row event-item">
                                    <div className="col-lg-6">
                                    <Image width={546} height={364} src="/img/event-private.jpg" className="img-fluid" alt="events"/>
                                    </div>
                                    <div className="col-lg-6 pt-4 pt-lg-0 content">
                                ...
                                <div className="swiper-slide">
                                  <div className="row event-item">
                                    <div className="col-lg-6">
                                    <Image width={546} height={364} src="/img/event-custom.jpg" className="img-fluid" alt="happy"/>
                                    </div>
                                    <div className="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-1.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-1.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-2.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-2.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-3.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-3.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-4.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-4.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-5.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-5.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-6.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-6.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-7.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-7.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                      <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-8.jpg" class="gallery-lightbox">
                          <Image width={320} height={437} src="/img/gallery/gallery-8.jpg" alt="" class="img-fluid"/>
                        </a>
                      </div>
                    </div>
                      ...
                      <div class="container">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <div class="member">
                              <div class="pic"><Image width={416} height={416} src="/img/chefs/chefs-1.jpg" class="img-fluid" alt="chefs"/></div>
                          ...
                          <div class="col-lg-4 col-md-6">
                            <div class="member">
                              <div class="pic"><Image width={416} height={416} src="/img/chefs/chefs-2.jpg" class="img-fluid" alt="chefs"/></div>
                              <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                                <span>Patissier</span>
                                <div class="social">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <div class="member">
                              <div class="pic"><Image width={416} height={416} src="/img/chefs/chefs-3.jpg" class="img-fluid" alt="chefs"/></div>
                              <div class="member-info">
                          ...
                          <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                              <div class="testimonial-item">
                                <Image width={100} height={100} src="/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="testimonios"/>
                                <h3>Saul Goodman</h3>
                                <h4>Ceo &amp; Founder</h4>
                                <div class="stars">
                            ...
                            <div class="swiper-slide">
                              <div class="testimonial-item">
                                <Image width={100} height={100} src="/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="testominios"/>
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                                <div class="stars">
                                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                            ...
                            <div class="swiper-slide">
                              <div class="testimonial-item">
                                <Image width={100} height={100} src="/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="testimonios"/>
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                                <div class="stars">
                                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                            ...
                            <div class="swiper-slide">
                              <div class="testimonial-item">
                                <Image width={100} height={100} src="/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="testomonios"/>
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                                <div class="stars">
                                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                            ...
                            <div class="swiper-slide">
                              <div class="testimonial-item">
                                <Image width={100} height={100} src="/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="testominios"/>
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                                <div class="stars">
                                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
